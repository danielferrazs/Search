...
- "Search with …" in a page's right-click menu searches in a new tab in Search itself (using the search engine chosen in Settings) rather than sending the query out to your Mac's default browser.
